                    ...
                    <div class="card shadow-z-2 rounded-3 m-3">
                        ...
                        <div class="card-header">
                            <h5 class="card-title mb-0">
                                <i class="icon-cart-plus me-2"></i> پیش‌نمایش سبد خرید
                            </h5>
                        </div>
                            ...
                            <div id="cart-items-container" class="d-none">
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-8">
                                        <div class="note-card">
                                            <p class="mb-0">
                                                مجموع مبلغ پرداختی مشخص شده است. با کلیک روی دکمه رزرو و پرداخت، مبلغ از موجودی شما کسر می‌شود و به لیست رزروها منتقل می‌شوید. در غیر اینصورت برای شارژ اعتبار هدایت می‌شوید.
                                            </p>
                                        </div>
                                    </div>
